...
void TSI_Init_SelfMode(void)
{
    ...
    config.commonConfig.mainClock   = kTSI_MainClockSlection_0;   // 16.65MHz
    ...
    config.commonConfig.chargeNum   = kTSI_SscChargeNumValue_1;   /* SSC output bit0's period setting */
    config.commonConfig.noChargeNum = kTSI_SscNoChargeNumValue_1; /* SSC output bit1's period setting */

    config.enableSensitivity = 1;                                 /* Enable sensitivity boost of self-cap or not */
    config.xdn               = kTSI_SensitivityXdnOption_0;       /* Sensitivity XDN option   */
    config.ctrim             = kTSI_SensitivityCtrimOption_2;     /* Sensitivity CTRIM option */
    config.inputCurrent      = kTSI_CurrentMultipleInputValue_1;  /* Input current multiple   */
...
void TSI_Init_MutualMode(void)
{
    ...
    config.commonConfig.decimation  = kTSI_SincDecimationValue_1; /* SINC decimation value */
